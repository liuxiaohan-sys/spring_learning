...
public interface OrderMapper {
    ...
    @Results(id = "orderMap", value = {
            ...
            @Result(column = "maker_id", property = "maker",
                    one = @One(select = "learning.spring.binarytea.repository.mybatis.TeaMakerMapper.findById")),
            @Result(column = "id", property = "items",
                    many = @Many(select = "learning.spring.binarytea.repository.mybatis.MenuItemMapper.findByOrderId"))
    })
